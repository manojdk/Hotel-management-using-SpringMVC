...
@Controller // the class which is handling all the user request is controller
...
public class OwnerController {
	...
	public ModelAndView saveOwner(@ModelAttribute Owner owner){
		...
		String message = ownerDao.savewOwner(owner);
		ModelAndView mv = new ModelAndView();
	...
	public void ownerLogin(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		if(owner!=null) {
			...
			out.println("<center><h2>INVALID CREDENTIALS</h2></center>");
